    ...
    <div className="flex gap-4 md:gap-8 justify-center mt-10 w-full px-4">
      {[
        ...
        <motion.div 
          ...
          className="flex flex-col items-center bg-white/60 border border-brand-sage/40 p-4 md:p-6 rounded-3xl min-w-[75px] md:min-w-[100px] backdrop-blur-md shadow-sm"
        >
          <span className="text-3xl md:text-5xl font-serif text-text-main mb-2 tabular-nums">{item.value.toString().padStart(2, '0')}</span>
          <span className="text-[10px] md:text-xs uppercase tracking-[0.2em] text-brand-emerald font-bold">{item.label}</span>
        </motion.div>
      ))}
    </div>
  );
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#FAF8F5] selection:bg-brand-sage/40">
      ...
      <motion.div 
        ...
        className="relative z-10 bg-white/30 backdrop-blur-2xl border border-white/60 rounded-[3rem] p-10 md:p-20 flex flex-col items-center text-center shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)] max-w-5xl mx-4 w-full mt-20"
      >
        <motion.p 
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-4 lg:gap-10 w-full mb-10">
          ...
          <motion.div 
            ...
            className="text-brand-sage text-5xl md:text-7xl font-light italic"
          >
            &
          </motion.div>
        ...
        <motion.div 
          ...
          className="w-full max-w-[250px] h-[1px] bg-gradient-to-r from-transparent via-brand-emerald/30 to-transparent mb-10"
        />
