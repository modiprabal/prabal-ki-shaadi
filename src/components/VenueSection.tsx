...
export default function VenueSection() {
  const { location, events } = weddingConfig;
  const venueEventsCount = events.filter((event) => event.venue === location.weddingVenue).length;
        ...
        <div className="grid md:grid-cols-2 gap-16 md:gap-20 items-center">
          ...
          >
            ...
            <p className="font-sans text-sm leading-[1.8] mb-8" style={{ color: "var(--theme-text-body)" }}>
              ...
              a grand mandap, and warm hospitality &mdash; the perfect setting for our celebrations.
            </p>

            <div className="flex gap-12 mb-10">
              {[
                { n: String(venueEventsCount), l: "Events" },
                { n: "2", l: "Days" },
                { n: "23-24", l: "June" },
              ].map(({ n, l }) => (
                <div key={l}>
